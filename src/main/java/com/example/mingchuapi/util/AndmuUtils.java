...
//	}
//
//	public static AndmuResult getRealtimeThumbnail(String token, String deviceId) {
//		AndmuResult result = new AndmuResult();
//		SortedMap<String,Object> param = new TreeMap<>();
//		param.put("deviceId", deviceId);
//		String paramStr = JSONObject.toJSONString(param);
//		log.info("realtime thumbnail param ->" + paramStr);
//		String rsp = sendPost(REALTIME_THUUMBNAIL_URL, paramStr, token);
...
//	}
//
//	public static AndmuResult getDeviceStatus(String token, String deviceId) {
//		AndmuResult result = new AndmuResult();
//		SortedMap<String,Object> param = new TreeMap<>();
//		param.put("deviceId", deviceId);
//		String paramStr = JSONObject.toJSONString(param);
//		log.info("device status param ->" + paramStr);
//		String rsp = sendPost(DEVICE_INFO_URL, paramStr, token);
...
//					result.getStatusMap().put(json.getString("deviceId"), json.getString("deviceStatus"));
//				}
//			}
//		}
//		return result;
