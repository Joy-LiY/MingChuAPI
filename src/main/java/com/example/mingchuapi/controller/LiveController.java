...
public class LiveController {
    ...
    public Map<String, Object> getLiveURL(String shop_id, String device_id, String channel_idx, @RequestParam(name = "upload_rate", defaultValue = "0") Integer upload_rate,
        ...
        return liveService.getLiveUrl(device_id, 0, response);
    ...
    public Map<String, Object> getLiveBackURL(String shop_id, String device_id, String channel_idx, @RequestParam(name = "upload_rate", defaultValue = "0") Integer upload_rate,
                                              ...
                                              @RequestParam(name = "expire_time", defaultValue = "24") Integer expire_time,
                                              HttpServletResponse response) {
        return liveService.getLiveBackUrl(device_id, start_time, stop_time, response);
    }
